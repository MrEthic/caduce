...
$lg = [
    ...
    "home" => [
        ...
        "sec-2" => [
            ...
            "card-3" => [
                "title-a" => "Administration",
                "title-b" => " facile",
                "desc" => "Gérer facilement vos ambulancier :",
                "li-1" => "Analyse des performances",
                "li-2" => "Méssagerie interne",
                "li-3" => "Ajout de membres simple",
                "li-4" => "Suspension de compte"
            ]
        ],
        "sec-3" => [
